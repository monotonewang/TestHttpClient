...
String debugCheckMobile = "/user/anno/loginBasic";//判断手机是否被注册
...
//String url = "http://35.164.1.183:7000/auth/register/email/check";//校验邮箱验证码
    ...
    public void postFormByApplicationJson() {
        ...
        System.out.println("url=" + debugCheckMobile);
        HttpPost httppost = new HttpPost(debugCheckMobile);        // 创建httppost
        httppost.addHeader("Content-type", "application/json; charset=utf-8");

        httppost.addHeader("token", "eyd0b2tlbl90eXBlJzogJ2FjY2VzcycsICd0eXAnOiAnSldUJ30=..d014bd666dc1ccde986617d4e67a4c6ae4a1e3a868dea6cfdfbc9b4349fb6aba");
...
//                    System.out.println("Response content: \n" + EntityUtils.toString(entity, "UTF-8"));
    ...
    public void testCheckPhone(){
                HttpBaseApplicationJson.postFormByApplicationJson(string,debugCheckMobile);
    }
}
